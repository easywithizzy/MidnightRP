...
function addContact(source, identifier, number, display)
    ...
    MySQL.Sync.insert("INSERT INTO phone_users_contacts (`identifier`, `number`,`display`) VALUES(@identifier, @number, @display)", {
        ['@identifier'] = identifier,
        ['@number'] = number,
        ['@display'] = display,
    },function()
...
function updateContact(source, identifier, id, number, display)
    local sourcePlayer = tonumber(source)
    MySQL.Sync.insert("UPDATE phone_users_contacts SET number = @number, display = @display WHERE id = @id", { 
        ['@number'] = number,
        ['@display'] = display,
        ['@id'] = id,
    },function()
...
AddEventHandler('gcPhone:sendMessage', function(phoneNumber, message, xPlayer)
    local sourcePlayer = tonumber(source)
	xPlayer = ESX.GetPlayerFromId(source)
    identifier = xPlayer.identifier
...
AddEventHandler('gcPhone:setReadMessageNumber', function(source, num)
	xplayer = ESX.GetPlayerFromId(source)
    identifier = xplayer.identifier
