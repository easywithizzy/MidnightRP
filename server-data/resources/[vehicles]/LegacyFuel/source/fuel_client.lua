...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			if displayHud then
				DrawAdvancedText(0.1430 - x, 0.7930 - y, 0.005, 0.0028, 0.40, ""..fuel.."%", 0, 201, 83, 255, 6, 1)
				DrawAdvancedText(0.125 - x, 0.7935 - y, 0.005, 0.0020, 0.40, "Fuel:", 255, 255, 255, 255, 4, 1)
			else
				Citizen.Wait(750)
			end
