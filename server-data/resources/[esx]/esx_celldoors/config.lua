...
Config.DoorList = {
	...
	-- Double doors to cells
	{
		objName = 'v_ilev_rc_door2',
		objCoords  = {x = 1850.74, y = 3684.12, z = 34.21},
		textCoords = {x = 1850.72, y = 3683.85, z = 34.21},
		locked = true
	},

	{
		objName = 'v_ilev_rc_door2',
		objCoords  = {x = 1851.51, y = 3682.78, z = 34.22},
		textCoords = {x = 1851.33, y = 3682.62, z = 34.22},
		locked = true
	},
	...
	{
	    objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = 1848.45, y = 3682.05, z = 34.21},
		textCoords = {x = 1848.25, y = 3682.3, z = 34.2},
		locked = true
	},

	{
	    objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = 1846.66, y = 3685.11, z = 34.2},
		textCoords = {x = 1846.59, y = 3685.4, z = 34.2},
		locked = true
	},

	{
	    objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = 1844.73, y = 3688.45, z = 34.2},
		textCoords = {x = 1844.93, y = 3688.12, z = 34.2},
		locked = true
	},
	...
	{
		objName = 'v_ilev_rc_door2',
		objCoords  = {x = 1847.86, y = 3689.76, z = 34.2},
		textCoords = {x = 1848.13, y = 3689.82, z = 34.22},
		locked = true
	},

	{
		objName = 'v_ilev_rc_door2',
		objCoords  = {x = 1849.38, y = 3690.55, z = 34.2},
		textCoords = {x = 1849.09, y = 3690.39, z = 34.2},
		locked = true
	},
	...
	{
		objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = -432.78, y = 5991.92, z = 31.72},
		textCoords = {x = -432.99, y = 5992.27, z = 31.72},
		locked = true
	},
	...
	{
	    objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = -428.67, y = 5996.54, z = 31.72},
		textCoords = {x = -428.85, y = 5996.87, z = 32.72},
		locked = true
	},

	{
	    objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = -431.75, y = 5999.65, z = 31.72},
		textCoords = {x = -431.96, y = 5999.91, z = 31.72},
		locked = true
	},
