...
Config.PointMarker = {Type = -1, r = 0, g = 0, b = 0, x = 7.0, y = 7.0, z = 1.0} -- Green Color / Standard Size Circle.
Config.DeleteMarker = {Type = 1, r = 255, g = 0, b = 0, x = 5.0, y = 5.0, z = 1.0} -- Red Color / Big Size Circle.
Config.PoundMarker = {Type = -1, r = 0, g = 0, b = 100, x = 7.0, y = 7.0, z = 1.0} -- Blue Color / Standard Size Circle.
Config.JPoundMarker = {Type = -1, r = 255, g = 0, b = 0, x = 7.5, y = 7.5, z = 1.0} -- Red Color / Standard Size Circle.

Config.GarageBlip = {Sprite = 357, Color = 3, Display = 2, Scale = 1.0} -- Public Garage Blip.
Config.PGarageBlip = {Sprite = 524, Color = 3, Display = 2, Scale = 1.0} -- Private Garage Blip.
Config.PoundBlip = {Sprite = 524, Color = 3, Display = 2, Scale = 1.0} -- Pound Blip.
...
Config.CarGarages = {
	...
	Bay_City_Ave = {
		Marker = vector3(-1547.99, -583.73, 25.71),
		Spawner = vector3(-1552.81, -577.18, 25.71),
		Deleter = vector3(-1536.86, -578.68, 24.71),
		Heading = 157.84
	},

	legiongarage = {
		Marker = vector3(51.71, -874.68, 30.42),
		Spawner = vector3(42.4, -882.54, 30.28),
		Deleter = vector3(37.09, -871.09, 29.44),
		Heading = 167.08
	},
